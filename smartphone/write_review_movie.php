...
<form id="form1" name="form1" method="post" action="write_review_movie1.php?idm=<? echo $idm;?>">
  ...
  <tr>
    ...
    <td width="95%">
      ...
      <tr>
        <td width="50" class="head03">Plot:</td>
        <td width="50" class="head03"><select name="ddl_plot"  id="ddl_plot">
          <? for($i=0;$i<=10;$i++){?>
...
Main event of the story. Everything that unfolds from beginning to end.
</td> </td>             
...
<td width="350" class="head03">
How did you feel throughout the movie? Did it make you cry, laugh, sad, happy..?
</td> 
</td>
        <td class="head03">&nbsp;</td>
      </tr>
