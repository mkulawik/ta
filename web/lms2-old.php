...
$shows=mysql_query("select * from shows where id=".$r['id_movie']);
...
<div class="ratetable ratingtable58">
  <div class="ratetable-inner">
      ...
      <div class="ratetable-column-wall">
        ...
        <div class="ratetable-feature-lbl"></div>
...
?>
      ...
      <div class="ratetable-column-wall">
       <div class="ratetable-header">
         ...
         <p>(<?echo $shoyr[$j];?>)</p>  
	<div> <a href="shoie.php?idm=<? echo $shoid[$j];?>"> <img src="shoies/<? echo $shoimg[$j];?>" width="65"/></a> </div>
          <div class="ratetable-header-inner">
...
?>
      ...
      <div class="ratetable-column-wall">
       <div class="ratetable-header">
          <div class="ratetable-fld-name">  <a href="shoie.php?idm=<? echo $shoid[$j];?>"><? echo $shotext[$j];?> </a> </div>
         <p>(<?echo $shoyr[$j];?>)</p>  
	<div> <a href="shoie.php?idm=<? echo $shoid[$j];?>"> <img src="shows/<? echo $shoimg[$j];?>" width="65"/></a> </div>
          <div class="ratetable-header-inner">
