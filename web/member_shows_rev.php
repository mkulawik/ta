...
//calculate overall rating for shows
...
$review=mysql_query("select * from rating where id_member=".$idm. " && id_shows>0 order by id desc"); 
?>
...
?>
              ...
              <tr>
                  <td width="10%" class="head03">Show: <span style="font-size:20px;"><? echo $mov['show_name'];?></span></td>
	</td>  
        <tr>
          ...
          <tr>
             <td width="24%" rowspan="3" class="head03"><img src="shows/<? echo $mov['image'];?>" width="70" class="img-border" /></td>
          </tr>
  <tr>
