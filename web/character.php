...
<div font="Arial" style="font-size:28px;width:100%;"><? echo $char['char_name'];?></div>
...
<table width="300" border="3" cellpadding="5">
<tr>
<td align="center" valign="center">
<a href="movie.php?idm=<? echo $char_mov['id'];?>"><img class="img-border" src="movies/<? echo $char_mov['image'];?>" width="55"></a>
<br />
<span style="font-size:12px"> Movie: </br>
<a href="movie.php?idm=<? echo $char_mov['id'];?>">
<? echo $char_mov['movie_name'];?>
</a> </span>

</td>

<td align="center" valign="center">
<a href="profile.php?idm=<? echo $char_act['id'];?>"><img class="img-border" src="actors/<? echo $char_act['image'];?>" width="55"></a>
<br>
<span style="font-size:12px"> Portrayed by: <br />
...
<div class="tab-content" id="1" style="display:block;">
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="265" class="head02">ACTOR</td>
      <td width="278" class="head02">CHARACTER</td>
      <td width="157" class="head02">SCORE</td>
    </tr>
    <tr>
