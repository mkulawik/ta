<html>
<head>
	<title>Responsive ratetables</title>
	<link rel="stylesheet" type="text/css" media="all" href="ratetable.css" />
	<style>
...
<div class="ratetable ratingtable58">
  <div class="ratetable-inner">
      ...
      <div class="ratetable-column-wall">
        <div class="ratetable-header">
          ...
          <div class="ratetable-header-inner">
            <div class="ratetable-fld-rate"><span class="cur">$</span>0</div>
            <p>0</p>
          </div>
        </div>
        <ul class="features">
      ...
      <div class="ratetable-column-wall">
       <div class="ratetable-header">
          <div class="ratetable-fld-name">Avatar</div>
          <div> <img src="images/avatar.jpg" width="45%" /> </div>
          <div class="ratetable-header-inner">
            <div class="ratetable-fld-rate">10.0</div>
