...
<div class="tab" id="tab4"><a href="javascript:void();" onclick="show_tab('4');" class="tab-link">My Vid</a></div>
...
<div class="tab-content"  id="1" style="display:block;">	
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="55%" class="head02">MOVIES</td>
      <td width="25%" class="head02">USER SCORE</td>
      <td width="25%" class="head02">YEAR</td>
    </tr>
	 <tr>
...
$color=FALSE;
$tscore=0;
$review=mysql_query("select * from rating where id_member=".$idm."&& id_movie > 0 order by rating_date desc");
...
<!-- ************* LIST SHOWS ************** --> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr><td> &nbsp;</td></tr>
    <tr>
      <td width="50%" class="head02">SHOWS</td>
      <td width="25%" class="head02">USER SCORE</td>
      <td width="25%" class="head02">YEAR</td>
    </tr>
	 <tr>
