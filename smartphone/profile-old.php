...
<? if ($net_avg >= 8) { echo '<img src="smartphone/images/hot-temp-anim.gif">';} 
...
<div class="tab-content" id="2" style="display:none;">
 ...
 <tr>
        <td colspan="2" class="head03"><a href="actor_reviews.php?idm=<? echo $idm;?>">Read All Reviews</a> </td>
 </tr>
  <?
...
<table width="50%" border="0" cellpadding="2" cellspacing="0" bgcolor="#eae4db">
 
      <tr>
        <td colspan="2" class="head02">Member: <? echo $m['name'];?></td>
      </tr>
      <tr>
        <td width="60%" rowspan="3" align="left" valign="top"><img src="members/<? echo $m['image'];?>" width="50" /></td>
    ...
    <tr>
            <td colspan="2"></td>
      <td width="200" rowspan="5" valign="top" class="head03" style="font-size:12px;">
...
<tr> <td align="right" width="22%">Acting: &nbsp  </td> <td align="left" width="7%">  <span class="<?=getRatingColor ($rate['acting']);?>">  <? echo $r['acting'];?></span></td> </tr>
<tr> <td align="right" width="22%">Performance: &nbsp  </td> <td align="left" width="7%">  <span class="<?=getRatingColor ($rate['performance']);?>">  <? echo $r['performance'];?></span></td> </tr>
...
<tr> <td align="right" width="22%">Screen Presence: &nbsp </td> <td align="left" width="7%">  <span class="<?=getRatingColor ($rate['screen_presence']);?>">  <? echo $r['screen_presence'];?></span></td> </tr>
<tr> <td align="right" width="22%">Characterization: &nbsp </td> <td align="left" width="7%">  <span class="<?=getRatingColor ($rate['characterization']);?>"> <? echo $r['characterization'];?></span></td> </tr>
