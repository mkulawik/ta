...
<table cellpadding="15" cellspacing="10"> 
 <tr><td>Profile Name: &nbsp;</td><td>
  <input type="text" name="membername" size="17">
</td>
...
<input type="password" name="fvpassword" size="17">
</td>
...
<input type="int" name="verifynum" size="7">
...
<align="right"><input class="button1" type="submit" name="submit" value="Update!">
</span>
</form>
</div>
