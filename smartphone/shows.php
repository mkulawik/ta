...
$review=mysql_query("select * from rating where id_shows=".$idm. " order by id desc");
...
<div class="wrap"><br>
<div class="breadcrumbs">Home > Shows > <? echo $sho['show_name'];?></div>
<div class="score" style="font-size:28px;width:100%;"><? echo $sho['show_name'];?>&nbsp;
 <span style="font-size:20px">(<? echo $sho['year']; ?>)</span></div>
<br />
...
<img src="shows/<? echo $sho['image'];?>" width="150px" />
<br>
<br>
<br>
</div>
...
<li>
	<? 
        ...
        if(isset($_SESSION['idm'])){
  		$flag=mysql_query("select * from rating where id_member=".$_SESSION['idm']." and id_shows=".$idm);
	...
	if($tflag>0){?>
        ...
        <font size="2"> <a <? if(isset($_SESSION['idm'])){?> href="write_review_shows.php?idm=<? echo $idm;?>"  <?} else {?> href="log-in.php" <? }?> class="button">Rate me</a></font>
        <? }?>
...
<div> <a href="shows_reviews.php?idm=<?echo $idm; ?>" class="button">Read All Reviews</a></div>

	<? include("shows_reviews2_tab.php"); ?>
...
<div class="tab-content" id="3" style="display:none;">
           <? if(isset($_SESSION['idm'])){?>
<div> <a href="upload_photos.php?idm=<?echo $idm; ?>&amp;type=shows" class="button">Upload Photo for this show</a></div>
          <?
          }
       else {
...
<div class="tab-content" id="4" style="display:none">
	   <? if(isset($_SESSION['idm'])){?>
<div> <a href="upload_videos.php?idm=<?echo $idm; ?>&amp;type=shows" class="button">Upload Video for this show</a></div>
          <?
          }
       else {
        ?> <br />Login to upload videos <br /> <?
