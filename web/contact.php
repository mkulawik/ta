...
-->
				 	 	<p>Email: <span><a href="#">info(at)fadviews.com</span></a></p>
				   		<p>Follow us on: <span><a href="https://www.facebook.com/people/Fad-Views/100007088836536">Facebook</a></span>, <span><a href="http://www.twitter.com/fadviews">Twitter</a></span>, <span><a href="https://www.youtube.com/channel/UCLPj5PLKynZ1IC23ZZQs_wg">YouTube</a></span></p>
				   </div>
				</div>					
...
<div class="clearF"></div>
						    ...
						    <div>
						    	...
						    	<span><textarea name="contactMsg" id="contactMsg" value="<? if(isset($_SESSION['cMsg'])){echo $_SESSION['cMsg'];}else{echo "Message";}?>"/> </textarea></span>
						    </div>
