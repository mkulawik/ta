...
<?
	...
	?>
	<br/ > <br />
 <a href="profile_gifts.php?idm=<?echo $idm ?>">
	<img src="smartphone/images/flower.png" width="8%"> <? echo $tot_flow2; ?> </br>
 </a>
 ...
 <a href="profile_gifts.php?idm=<?echo $idm ?>">
	<img src="smartphone/images/teddy.png" width="15%"> <? echo $tot_tedd2; ?> </br>
 </a>
	<?
...
<div> <a href="actor_reviews.php?idm=<?echo $idm; ?>" class="button">Read All Reviews</a></div>
