...
<div class="score" style="font-size:28px;width:100%;"><? echo $sho['show_name'];?> &nbsp; <span style="font-size:20" >(<? echo $sho['year']; ?>)</span></div>


<img src="shows/<? echo $sho['image'];?>" width="300px" style="margin-bottom:20px" />
...
<li>
	...
	if($tflag>0){?>
        ...
        <a <? if(isset($_SESSION['idm'])){?> href="write_review_shows.php?idm=<? echo $idm;?>"  <?} else {?> href="log-in.php" <? }?> class="button">Rate me</a>
        <? }?>
...
<div class="tab-content"  id="1" style="display:block;">	
  <table width="600" border="0" cellspacing="0" cellpadding="0">
    ...
    <?
        $color=FALSE;
        $characters=mysql_query("select * from characters where id_shows=".$idm);
// ***** While start ****************
